      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass rounded-2xl p-8 border border-white/8 shadow-2xl shadow-black/40">
          <div className="mb-7">
            ...
            <p className="text-slate-400 text-sm">Start collaborating with your team today.</p>
          </div>
          ...
          <a
            ...
            id="signup-google"
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-200 text-white text-sm font-medium mb-5"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-xl px-4 py-3 text-sm text-white placeholder-slate-600 outline-none transition-all duration-200 focus:ring-1 focus:ring-purple-500/60"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full rounded-xl px-4 py-3 pr-11 text-sm text-white placeholder-slate-600 outline-none transition-all duration-200 focus:ring-1 focus:ring-purple-500/60"
                  style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}
                />
                <button
                  type="button"
